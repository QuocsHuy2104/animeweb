...
INSERT INTO HOADON VALUES ('HD0001',CAST('2023-11-23' AS Date),2000,1,'KH0001','KyDV')
...
SELECT * FROM HDCT
INSERT INTO HDCT VALUES ('HDCT001',1000,2,'HD0001','SP0001')
INSERT INTO HDCT VALUES ('HDCT002',2000,2,'HD0001',(SELECT MASP FROM SANPHAM WHERE TenSP LIKE N'Áo cưới'))
...
INSERT INTO DICHVU VALUES ('DV0002',N'Thu âm',7600,N'DV0002 - Thu âm','SP0003')
INSERT INTO DICHVU VALUES ('DV0003',N'Thuê đồ cưới',9600,N'DV0003 - Thuê đồ cưới','SP0005')
