            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body bg-white">
                        <div class="mt-5">
                            <form action="/ASM/admin-fav-user" method="post">
                                <select class="form-select" aria-label="Default select example" name="videoID">
                                    <option selected>Please select tile video here !</option>
                            ...
                            <div class="table-responsive container-fluid mt-4">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">Reciver email</th> <%-- // Email nguoi nhan --%>
